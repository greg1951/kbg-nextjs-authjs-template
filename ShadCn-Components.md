...
2. [Form Component](#form-component)
   ...
   2. [Anatomy](#anatomy)
   3. [Form](#form)
      1. [Create a form schema](#create-a-form-schema)
      2. [Setup the form](#setup-the-form)
      3. [Build the form](#build-the-form)
      4. [Done](#done)
   4. [Validation](#validation)
      1. [Client-side Validation](#client-side-validation)
      2. [Validation Modes](#validation-modes)
   5. [Displaying Errors](#displaying-errors)
   6. [Working with Different Field Types](#working-with-different-field-types)
      1. [Input](#input)
      2. [Textarea](#textarea)
      3. [Select](#select)
      4. [Checkbox](#checkbox)
      ...
      6. [Switch](#switch)
      7. [Complex Forms](#complex-forms)
   7. [Resetting the Form](#resetting-the-form)
   8. [Array Fields](#array-fields)
      1. [Using useFieldArray](#using-usefieldarray)
      2. [Array Field Structure](#array-field-structure)
      3. [Controller Pattern for Array Items](#controller-pattern-for-array-items)
      4. [Adding Items](#adding-items)
      5. [Removing Items](#removing-items)
      6. [Array Validation](#array-validation)
3. [Card](#card)
   1. [component: true](#component-true)
...
1. To install the [Form component](https://react-hook-form.com) run the following: `npx shadcn@latest add form`
2. This will install three `components/ui` files in the project: `button.tsx`, `form.tsx`, and `label.tsx`
3. The form is to be rendered inside a Card component which is installed by running: `npx shadcn@latest add card`. The `@/components` directory will now include `Card`.
4. Because the components style with Tailwind, also install the VS Code `Tailwind CSS Intellisense` extension as well.
5. The shadcn Form component does not provide an input fields and those too must be installed: `npx shadcn@latest add input`. The `@/components` directory will now include `Input`.

*What is different about shadcn is that the components are created in your project and are available to be updated within the project. This is a different approach taken by other libraries which require you to import in a dependency.* 
